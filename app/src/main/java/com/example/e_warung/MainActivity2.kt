...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        kurang1 = findViewById(R.id.imageButton4)
        kurang2 = findViewById(R.id.imageButton6)
        plus1 = findViewById(R.id.imageButton5)
        plus2 = findViewById(R.id.imageButton7)
        jum1 = findViewById(R.id.textView17)
        jum2 = findViewById(R.id.textView27)
        jumlahtotal = findViewById(R.id.textView26)
        totalBayar = findViewById(R.id.textView29)
        ...
        fun setMins(view: View) {
            ...
            if (jumlah1==0) {
                Toast.makeText(this,"minum pesanan 1", Toast.LENGTH_SHORT).show()
            }else{
                jumlah1=jumlah1 - 1
    ...
    fun setPlus(view: View) {
        jumlah1 = jum1.text.toString().toInt()
        if (jumlah1 == 5) {
            Toast.makeText( this, "minum pesanan 5", Toast.LENGTH_SHORT).show()
        } else {
            jumlah1 = jumlah1 + 1
            jum1.setText(jumlah1.toString())
            this.setJumTotalBeli()
